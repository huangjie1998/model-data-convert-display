...
def build_attrib_entity(state: Dict[str, object], context) -> Dict[str, object] | None | object:
    if state.get("et") != "acdbattribute":
        return NOT_HANDLED
    ...
    return {
        ...
        "semantic_type": "text",
        "semantic_subtype": "ATTRIB",
        "source_acdb_type": "ACDBATTRIBUTE",
        "geom": {
