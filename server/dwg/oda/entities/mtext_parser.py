...
def build_mtext_entity(state: Dict[str, object], context) -> Dict[str, object] | None | object:
    if state.get("et") != "acdbmtext":
        return NOT_HANDLED
    ...
    geom = {
        ...
        "actual_width": float(actual_width or 0.0),
    ...
    return {
        ...
        "semantic_type": "text",
        "semantic_subtype": "MTEXT",
        "source_acdb_type": "ACDBMTEXT",
        "geom": geom,
