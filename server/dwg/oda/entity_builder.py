...
def build_entity_from_oda_lines(
    *,
    ...
    state = {
        ...
        "end_angle": end_angle,
        "vertices": vertices,
        "vertex_segment_kinds": vertex_segment_kinds,
        "vertex_start_widths": vertex_start_widths,
        "vertex_end_widths": vertex_end_widths,
        "poly_closed_flag": poly_closed_flag,
        "poly_closed_seen": poly_closed_seen,
        "poly_start_width": poly_start_width,
        "poly_end_width": poly_end_width,
        "poly_global_width": poly_global_width,
        ...
        "major_axis_vec": major_axis_vec,
        "minor_axis_vec": minor_axis_vec,
        ...
        "mtext_background_fill_on": mtext_background_fill_on,
        "mtext_background_fill_color_raw": mtext_background_fill_color_raw,
        "mtext_background_scale_factor": mtext_background_scale_factor,
        "hatch_pattern_name": hatch_pattern_name,
        "hatch_solid_fill": hatch_solid_fill,
        "hatch_pattern_angle": hatch_pattern_angle,
        "hatch_pattern_scale": hatch_pattern_scale,
        "hatch_pattern_spacing": hatch_pattern_spacing,
        "hatch_loops": hatch_loops,
        "leader_has_arrowhead": leader_has_arrowhead,
        "leader_splined": leader_splined,
        "leader_arrow_block": leader_arrow_block,
        "leader_arrow_size": leader_arrow_size,
        "named_points": named_points,
        "dimension_line_point": dimension_line_point,
        "ext_line1_point": ext_line1_point,
        "ext_line2_point": ext_line2_point,
        ...
        "text_position_point": text_position_point,
    ...
    non_dimension_entity = build_non_dimension_entity(state, context)
