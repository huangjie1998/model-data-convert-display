...
from server.dwg.cad_model.builders.entity_factory import build_entity_from_raw
from server.dwg.cad_model.builders.spaces_builder import build_spaces
from server.dwg.cad_model.builders.tables_builder import (
    build_block_table,
