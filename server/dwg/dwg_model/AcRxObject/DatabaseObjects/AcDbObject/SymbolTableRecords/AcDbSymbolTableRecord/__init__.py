...
import sys as _sys
from ..ac_db_symbol_table_record import AcDbSymbolTableRecord as _AcDbSymbolTableRecord
_sys.modules[__package__.rsplit(".", 1)[0]].AcDbSymbolTableRecord = _AcDbSymbolTableRecord
