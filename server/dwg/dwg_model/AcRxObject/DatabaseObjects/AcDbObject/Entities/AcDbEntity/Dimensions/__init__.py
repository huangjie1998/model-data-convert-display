...
from .ac_db_dimension import AcDbDimension

__all__ = ["AcDbDimension"]
import importlib as _importlib
import sys as _sys
import types as _types

_CLASS_EXPORTS = {'AcDbDimension': ('server.dwg.dwg_model.AcRxObject.DatabaseObjects.AcDbObject.Entities.AcDbEntity.Dimensions.ac_db_dimension', 'AcDbDimension')}
