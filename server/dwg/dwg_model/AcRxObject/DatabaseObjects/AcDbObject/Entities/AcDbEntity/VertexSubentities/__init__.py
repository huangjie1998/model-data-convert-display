...
from .ac_db_vertex import AcDbVertex
...
_CLASS_EXPORTS = {'AcDbVertex': ('server.dwg.dwg_model.AcRxObject.DatabaseObjects.AcDbObject.Entities.AcDbEntity.VertexSubentities.ac_db_vertex', 'AcDbVertex')}
