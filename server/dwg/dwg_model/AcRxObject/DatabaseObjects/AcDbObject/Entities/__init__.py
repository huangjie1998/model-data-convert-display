...
from .ac_db_entity import AcDbEntity
...
_CLASS_EXPORTS = {'AcDbEntity': ('server.dwg.dwg_model.AcRxObject.DatabaseObjects.AcDbObject.Entities.ac_db_entity', 'AcDbEntity')}
